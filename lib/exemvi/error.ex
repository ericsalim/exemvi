defmodule Exemvi.Error do
  ...
  def invalid_object_value(:additional_consumer_data_request),
    do: :invalid_additional_consumer_data_request
  ...
  def invalid_object_value(:merchant_city_alternate_language),
    do: :invalid_merchant_city_alternate_language

  def invalid_object_value(:merchant_name), do: :invalid_merchant_name

  def invalid_object_value(:merchant_name_alternate_language),
    do: :invalid_merchant_name_alternate_language
  ...
  def invalid_object_value(:tip_or_convenience_indicator),
    do: :invalid_tip_or_convenience_indicator
  ...
  def invalid_object_value(:value_of_convenience_fee_fixed),
    do: :invalid_value_of_convenience_fee_fixed

  def invalid_object_value(:value_of_convenience_fee_percentage),
    do: :invalid_value_of_convenience_fee_percentage
  ...
  def missing_object_id(:merchant_name_alternate_language),
    do: :missing_merchant_name_alternate_language
  ...
  def orphaned_object(:value_of_convenience_fee_fixed),
    do: :orphaned_value_of_convenience_fee_fixed

  def orphaned_object(:value_of_convenience_fee_percentage),
    do: :orphaned_value_of_convenience_fee_percentage
end
